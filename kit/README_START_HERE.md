...
| 2 | **`slides/Cloud_DB_Security_Essentials_Facilitator_Deck.pptx`** | The presentation deck (20 slides): title, agenda, per-day teaching + lab slides, capstone deliverables, closing. |
